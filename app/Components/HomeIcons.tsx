...
const homeIconData = [
  { id: '1', name: 'sack-dollar', label: 'Utilities', screen: '/utilities' },
  { id: '2', name: 'piggy-bank', label: 'Savings', screen: '/savings' },
  { id: '3', name: 'folder-open', label: 'Folder', screen: '/folder' },
